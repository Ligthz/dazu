    ...
    methods: {
        ...
        getSummary() {
            if(this.option != null) {
                ...
                axios.get('/user-personal-sale/' + this.$key + '?o=' + this.option)
                .then(response =>{
        ...
        getSalesChart() {
            if(this.option != null) {
                ...
                axios.get('/user-personal-sale-chart/' + this.$key + '?o=' + this.option)
                .then(response =>{
                    let labelsArr = [];
                    let datasetsArr = [];
        ...
        getOrdersChart() {
            if(this.option != null) {
                ...
                this.chartLoading = true;
                axios.get('/user-personal-order-chart/' + this.$key + '?o=' + this.option)
                .then(response =>{
                    let labelsArr = [];
                    let datasetsArr = [];
                    response.data.current_records.forEach((obj) => {
        ...
        getOrdersRecordsTable() {
            if(this.option != null) {
                ...
                axios.get('/user-personal-sales/' + this.$key 
                    + '?o=' + this.option
                    + '&page=' + page
                    + '&order=' + order
                    + '&paginate=' + paginate
